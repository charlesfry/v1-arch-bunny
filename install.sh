...
run_phase "60-docker.sh" "Docker storage"
run_phase "70-neovim.sh" "Neovim Python environment"
run_phase "80-disk-alert.sh" "Disk usage alert"
run_phase "90-claude-code.sh" "Claude Code"
